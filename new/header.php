...
<!-- Favorites -->
<div class="form-check form-check-inline">
    <input class="form-check-input btn-check" type="radio" name="filterOptions" id="filterOptionsFav" value="favorite">
    <label class="form-check-label custom-btn">Favorites</label>
</div>
